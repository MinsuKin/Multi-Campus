...
document.getElementById('store_biz_number').value = 
	document.getElementById('store_biz_num1').value + "-"
	document.getElementById('store_biz_num2').value + "-"
	document.getElementById('store_biz_num3').value;
...
아이디
<input type ="text" name = "sikgu_id" id = "sikgu_id" value="${user.sikgu_id}" readonly>
사업자 등록 번호
<input type ="text" id = "store_biz_num1" maxlength="3" size="3">-
<input type ="text" id = "store_biz_num2" maxlength="2" size="2">-
<input type ="text" id = "store_biz_num3" maxlength="4" size="4"><br>
<input type ="hidden" id = "store_biz_number">


상호
<input type = "text" name = "store_name" id = "store_name"><br>

대표 연락처
<input type ="text" id = "store_phone1" maxlength="3" size="3">-
<input type ="text" id = "store_phone2" maxlength="4" size="4">-
<input type ="text" id = "store_phone3" maxlength="4" size="4"><br>
<input type ="hidden" name = "store_phone" id = "store_phone">


<input type="text" name="store_address" id="sample5_address" placeholder="주소">
...
<input type = "hidden" name = "store_x" id = "store_x" value = "">
<input type = "hidden" name = "store_y" id = "store_y" value = "">
<input type = "hidden" name = "store_video_path" id = "store_video_path" value = "">
