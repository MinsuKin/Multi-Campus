...
<!-- kakao map api 사용 -->
<script type="text/javascript" src="//dapi.kakao.com/v2/maps/sdk.js?appkey=11385b89f73bcc9d4dc2406ea538f4b9&libraries=services"></script>
			...
			<div class="container">
				<div class="wrap top">
					...
					<div style="display: flex;">
						...
						<input type="checkbox" id ="category" value =1/>치킨
						<input type="checkbox" id ="category" value =2/>한식
						<input type="checkbox" id ="category" value =3/>일식
						<input type="checkbox" id ="category" value =4/>중식
						<input type="checkbox" id ="category" value =5/>양식
						</form>
